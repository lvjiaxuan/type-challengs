...
type String2Union<S extends string> = S extends `${ infer F }${ infer Rest }` ? F | String2Union<Rest> : never

type DropString<S extends string, R extends string, _Result extends string = ''> =
