...
type ReplaceKeys<U extends Record<PropertyKey, unknown>, T, Y> = {
...
type c1 = ReplaceKeys<Nodes, 'name' | 'flag', { name: number; flag: string }>
type c2 = ReplaceKeys<Nodes, 'name', { aa: number }>
