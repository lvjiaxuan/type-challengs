...
// Mine.
// type GetMiddleElement<T extends unknown[], _Head extends 0[] = [], _HeadPlus extends 0[] = [ ..._Head, 0 ]> =
//   [ ..._Head, ..._Head, 0, 0 ]['length'] extends T['length']
//     ? [ T[_Head['length']], T[ _HeadPlus['length'] ] ]
//     : [ ..._Head, ..._Head, 0 ]['length'] extends T['length']
//       ? [ T[_Head['length']] ]
//       : _Head['length'] extends T['length']
//         ? []
//         : GetMiddleElement<T, [ ..._Head, 0 ]>

// Shorter https://github.com/type-challenges/type-challenges/issues/21130
type GetMiddleElement<T extends unknown[]> = T extends [ infer F, ...infer R, infer L ]
  ? R extends []
    ? [ F, L ]
    : GetMiddleElement<R>
  : T
