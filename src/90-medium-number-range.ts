...
type NumberRange<L extends number, H extends number, Counter extends 0[] = [], Result = L, IsOverL = false> =
  Counter['length'] extends H
    ? Result | Counter['length']
    : Counter['length'] extends L
      ? NumberRange<L, H, [ ...Counter, 0 ], Result | [ ...Counter, 0 ]['length'], true>
      : NumberRange<L, H, [ ...Counter, 0 ], Result | (IsOverL extends true ? [ ...Counter, 0 ]['length'] : never), IsOverL>
