...
// https://github.com/type-challenges/type-challenges/issues/16942
declare function defineStore<
  ...
  _Getters = {
    [P in keyof Getters]: Getters[P] extends (...args: any) => any ? ReturnType<Getters[P]> : never
  },
>(store: {
  id: string,
  state: () => State,
  getters?: Getters & ThisType<Readonly<State & _Getters>>,
  actions?: Actions & ThisType<State & Readonly<_Getters & Actions>>,
