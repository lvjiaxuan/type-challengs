/*
  ...
  And a union could collapse, which means some types could absorb (or be absorbed by) others and there is no way to prevent this absorption. See the following examples:
  ```ts
...
// From https://github.com/type-challenges/type-challenges/issues/19059
