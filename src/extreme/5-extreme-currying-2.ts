...
// Im fail at this challenge.

// https:// github.com/type-challenges/type-challenges/issues/18047
declare function DynamicParamsCurrying<T extends any[], R>(fn: (...args: T) => R):
T extends []
  ? R // returns R if no params is needed
  : <P extends unknown[]>(...args: P) =>
  T extends [ ...P, ...infer Rest ] // check does P & Rest extends T, basically checking is P fully T
