...
// type BinaryToDecimal<S extends string, _Result extends 0[] = [], _POS extends 0[] = []> =
//   S extends `${ infer Rest }1`
//     ? BinaryToDecimal<Rest, [ ..._Result, ...B_D_MAP[_POS['length']]], [ ..._POS, 0]>
//     : S extends `${ infer Rest }0`
//       ? BinaryToDecimal<Rest, _Result, [ ..._POS, 0]>
//       : _Result['length']

// https://github.com/type-challenges/type-challenges/issues/20364
...
type cases = [
  ...
  Expect<Equal<BinaryToDecimal<'1'>, 1>>,
